...
uniform sampler2D channel_fuji;
...
void main() {    
   vec4 pic1;
    ...
    vec4 pic0;
    pic0.r = texture2D(channel_fuji, vec2(pic1.r, 0.0)).r;
    pic0.g = texture2D(channel_fuji, vec2(pic1.g, 0.5)).g;
    pic0.b = texture2D(channel_fuji, vec2(pic1.b, 1.0)).b;
    pic0.a = 1.0;
    gl_FragColor = pic0;
}
