...
//#define SUPPPORTS_UNDOCUMENTED_APIS	
...
+ (UIImage *) doUnrotateImage: (UIImage *) image withAngle:(CGFloat)angle ;
// Paths
...
+(UIImage*)resetImageSizeBySize:(UIImage*)image withMinSide:(int)d;
...
+ (UIImage *) makeAImageWithColor:(RGB)rgb andSize:(CGSize)size;
