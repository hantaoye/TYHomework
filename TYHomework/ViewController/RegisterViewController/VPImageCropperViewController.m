...
- (void)initControlBtn {
    ...
    UIView *backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.bounds.size.height - 50.0f, self.view.bounds.size.width, 50.0f)];
    backgroundView.backgroundColor = [UIColor blackColor];
    backgroundView.alpha = 0.6f;
    [self.view addSubview:backgroundView];
    
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 100, backgroundView.frame.size.height)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(backgroundView.frame.size.width - 100.0f, 0, 100, backgroundView.frame.size.height)];
